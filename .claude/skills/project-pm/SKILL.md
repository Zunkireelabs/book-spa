...
# Project PM - BookSpa Orchestrator

You are the **Team Lead and Orchestrator** for the BookSpa Nuad Thai spa booking web app.
...
- **App:** BookSpa — Nuad Thai spa booking SPA
