-- Migration 065: referral reward redemption at checkout (additive, REVERSIBLE)
--
-- migration-058/062/063/064 built the customer_referrals + customer_referral_credits
...
--   -- get_referral_credit_balance: re-run migration-058's original definition to revert.
...
VALUES ('065', 'referral-reward-redemption')
