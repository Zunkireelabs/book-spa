-- Migration 159: is_return_leg column instead of note-text matching (additive, REVERSIBLE)
--
-- Both revert_staff_transfer_now() (migration-156/157) and apply_due_staff_reverts()
...
--             (and re-run migration-157/149 verbatim to drop the column writes)
...
-- Redefine revert_staff_transfer_now() (byte-for-byte migration-157's body, plus
