-- Migration 062: staff-selectable referral reward type + amount (additive, REVERSIBLE)
--
-- Extends migration-058's customer referral program: previously the reward was always a
...
--   -- migration-058-customer-referrals.sql
...
VALUES ('062', 'referral-reward-type') ON CONFLICT (version) DO NOTHING;
