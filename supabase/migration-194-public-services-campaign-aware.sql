-- Migration 194: public_get_services() campaign-awareness (additive, REVERSIBLE)
--
-- Same campaign layering as migration-193's dashboard view, applied to the
-- public RPC: if get_active_campaign_discount_percent() (migration-192)
...
--
-- DROP FUNCTION first, same reason as migration-189: RETURNS TABLE column
...
--
-- Reversible (manual): re-apply migration-189's CREATE OR REPLACE FUNCTION
...
VALUES ('194', 'public-services-campaign-aware')
