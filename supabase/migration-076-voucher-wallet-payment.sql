-- ============================================================
-- Migration 076: Voucher wallet balance as a booking payment tender
-- ============================================================
--
-- Vouchers (migration-072) and booking payments have been entirely disconnected
...
-- (migration-071) exactly, combined with claim_voucher()'s balance-check
-- logic (migration-072).
--
-- Two new pieces:
...
-- `vouchers` itself (that stays manager/admin-only, per migration-072/075).
...
VALUES ('076', 'voucher-wallet-payment')
