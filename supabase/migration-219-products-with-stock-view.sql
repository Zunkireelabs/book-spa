-- Migration 219: products_with_stock view (additive, REVERSIBLE)
--
-- Convenience view for the "Overall" (all-branches) catalog view: sums
-- each product's product_branch_stock (migration-214) rows into one
...
--
-- Explicit column list rather than p.* deliberately: migration-220 (right
...
VALUES ('219', 'products-with-stock-view')
